...
st.title(
    "Reserva de estación de trabajo"
)
...
st.caption(
    "Las reservas están disponibles de lunes a viernes "
    f"y pueden realizarse hasta con "
...
datos_externos = st.radio(
    "¿Entregará datos en disco externo "
...
acepta = st.checkbox(
    ...
    "es correcta y que utilizaré el espacio "
    "únicamente durante la franja reservada."
)
...
if GOOGLE_FORM_URL.strip():
    ...
    st.write(
        "Si SavIA-Lab requiere información "
        "adicional para su actividad, "
...
st.caption(
    "SavIA-Lab · Universidad El Bosque · "
    "Sistema de reservas"
)
